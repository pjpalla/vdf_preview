...
daily_kpi = c("eventname=in_out_points/disaggregation=", "eventname=arrivals_attendances/disaggregation=", "VodafoneAnalytics/eventname=mobility_graph=")
